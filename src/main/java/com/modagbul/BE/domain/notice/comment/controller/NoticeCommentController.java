...
public class NoticeCommentController {
    ...
    public ResponseEntity<ResponseDto<NoticeCommentDto.CreateNoticeCommentResponse>> createNoticeComment(@PathVariable Long teamId, @PathVariable Long noticeId, @Valid @RequestBody NoticeCommentDto.CreateNoticeCommentRequest createNoticeCommentRequest){
        return ResponseEntity.ok(ResponseDto.create(HttpStatus.OK.value(), NoticeCommentConstant.ENoticeCommentResponseMessage.CREATE_NOTICE_COMMENT_SUCCESS.getMessage(), noticeCommentService.createNoticeComment(noticeId, createNoticeCommentRequest)));
    }
    ...
    public ResponseEntity<ResponseDto<List<NoticeCommentDto.GetNoticeCommentResponse>>> getNoticeComment(@PathVariable Long teamId, @PathVariable Long noticeId){
        return ResponseEntity.ok(ResponseDto.create(HttpStatus.OK.value(), NoticeCommentConstant.ENoticeCommentResponseMessage.GET_NOTICE_COMMENT_SUCCESS.getMessage(), noticeCommentService.getAllNoticeCommentByNoticeId(noticeId)));
    }
}
