...
@RequestMapping("/api/v1/notice/{noticeId}/comment")
public class NoticeCommentController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<CreateNoticeCommentResponse>> createNoticeComment(@PathVariable Long noticeId, @Valid @RequestBody CreateNoticeCommentRequest createNoticeCommentRequest){
    ...
    public ResponseEntity<ResponseDto> deleteNoticeComment(@PathVariable Long noticeId, @PathVariable Long noticeCommentId){
